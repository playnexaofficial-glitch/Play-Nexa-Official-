...
-- ║  Version: 3.0 — All tables, RLS, RPCs, triggers, seed data     ║
-- ╚══════════════════════════════════════════════════════════════════╝

-- ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
-- STEP 0: CLEAN SLATE — Drop everything that might conflict
-- ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
...
CREATE TABLE yt_channels (
  ...
  scan_status         TEXT NOT NULL DEFAULT 'idle'
                      CHECK (scan_status IN ('idle', 'scanning', 'paused', 'completed')),
...
CREATE TRIGGER set_updated_at
  BEFORE UPDATE ON channel_display
  FOR EACH ROW EXECUTE FUNCTION update_updated_at_column();
...
CREATE TABLE app_features (
  ...
  status               TEXT NOT NULL DEFAULT 'live'
                       CHECK (status IN ('live', 'hidden', 'coming_soon', 'locked', 'maintenance')),
  description          TEXT NOT NULL DEFAULT '',
...
-- ── 3.22 notification_log (gamification pipeline) ───────────────
...
-- ── 3.23 videos (Edge Function / cron pipeline) ─────────────────
CREATE TABLE videos (
  ...
  category             TEXT NOT NULL DEFAULT 'movie'
                       CHECK (category IN ('movie', 'music', 'short')),
  genre                TEXT[] NOT NULL DEFAULT '{}',
  duration_sec         INTEGER NOT NULL DEFAULT 0,
  channel              TEXT NOT NULL DEFAULT '',
  language             TEXT NOT NULL DEFAULT 'English',
  region               TEXT NOT NULL DEFAULT 'international'
                       CHECK (region IN ('bangladesh', 'india', 'international')),
...
CREATE POLICY "movies_auth_insert" ON movies
  FOR INSERT TO authenticated WITH CHECK (true);

CREATE POLICY "movies_auth_update" ON movies
  FOR UPDATE TO authenticated USING (true) WITH CHECK (true);

CREATE POLICY "movies_service_role_all" ON movies
  FOR ALL TO service_role USING (true) WITH CHECK (true);

-- ── music_tracks ────────────────────────────────────────────────
CREATE POLICY "music_public_read" ON music_tracks
  FOR SELECT TO anon, authenticated USING (true);

CREATE POLICY "music_auth_manage" ON music_tracks
  FOR ALL TO authenticated USING (true) WITH CHECK (true);

CREATE POLICY "music_service_role_all" ON music_tracks
  FOR ALL TO service_role USING (true) WITH CHECK (true);

-- ── yt_channels ─────────────────────────────────────────────────
CREATE POLICY "channels_public_read" ON yt_channels
  FOR SELECT TO anon, authenticated USING (true);

CREATE POLICY "channels_auth_admin" ON yt_channels
  FOR ALL TO authenticated USING (true) WITH CHECK (true);

CREATE POLICY "channels_service_role_all" ON yt_channels
  FOR ALL TO service_role USING (true) WITH CHECK (true);

-- ── channel_display ─────────────────────────────────────────────
CREATE POLICY "channel_display_public_read" ON channel_display
  FOR SELECT TO anon, authenticated USING (true);

CREATE POLICY "channel_display_auth_admin" ON channel_display
  FOR ALL TO authenticated USING (true) WITH CHECK (true);

CREATE POLICY "channel_display_service_role_all" ON channel_display
  FOR ALL TO service_role USING (true) WITH CHECK (true);

-- ── ai_scan_jobs ────────────────────────────────────────────────
CREATE POLICY "scan_jobs_public_read" ON ai_scan_jobs
  FOR SELECT TO anon, authenticated USING (true);

CREATE POLICY "scan_jobs_auth_admin" ON ai_scan_jobs
  FOR ALL TO authenticated USING (true) WITH CHECK (true);

CREATE POLICY "scan_jobs_service_role_all" ON ai_scan_jobs
  FOR ALL TO service_role USING (true) WITH CHECK (true);

-- ── sync_logs ───────────────────────────────────────────────────
CREATE POLICY "sync_logs_public_read" ON sync_logs
  FOR SELECT TO anon, authenticated USING (true);

CREATE POLICY "sync_logs_service_role_all" ON sync_logs
  FOR ALL TO service_role USING (true) WITH CHECK (true);
...
CREATE POLICY "profiles_service_role_all" ON user_profiles
  FOR ALL TO service_role USING (true) WITH CHECK (true);
...
CREATE POLICY "user_likes_service_role_all" ON user_likes
  FOR ALL TO service_role USING (true) WITH CHECK (true);
...
CREATE POLICY "user_watchlist_service_role_all" ON user_watchlist
  FOR ALL TO service_role USING (true) WITH CHECK (true);
...
CREATE POLICY "user_history_service_role_all" ON user_history
  FOR ALL TO service_role USING (true) WITH CHECK (true);

-- ── music_likes ─────────────────────────────────────────────────
CREATE POLICY "music_likes_own" ON music_likes
  FOR ALL USING (auth.uid() = user_id)
  WITH CHECK (auth.uid() = user_id);

CREATE POLICY "music_likes_service_role_all" ON music_likes
  FOR ALL TO service_role USING (true) WITH CHECK (true);

-- ── music_saved ─────────────────────────────────────────────────
CREATE POLICY "music_saved_own" ON music_saved
  FOR ALL USING (auth.uid() = user_id)
  WITH CHECK (auth.uid() = user_id);

CREATE POLICY "music_saved_service_role_all" ON music_saved
  FOR ALL TO service_role USING (true) WITH CHECK (true);

-- ── admin_users ─────────────────────────────────────────────────
CREATE POLICY "admin_users_service_role_read" ON admin_users
  FOR SELECT TO service_role USING (true);

CREATE POLICY "admin_users_own_check" ON admin_users
  FOR SELECT USING (auth.uid() = user_id);

-- ── admin_activity_log ──────────────────────────────────────────
CREATE POLICY "admin_activity_service_role_all" ON admin_activity_log
  FOR ALL TO service_role USING (true) WITH CHECK (true);

CREATE POLICY "admin_activity_auth_read" ON admin_activity_log
...
-- ── app_features ────────────────────────────────────────────────
CREATE POLICY "features_public_read" ON app_features
  FOR SELECT TO anon, authenticated USING (true);

CREATE POLICY "features_auth_manage" ON app_features
  FOR ALL TO authenticated USING (true) WITH CHECK (true);

CREATE POLICY "features_service_role_all" ON app_features
  FOR ALL TO service_role USING (true) WITH CHECK (true);
...
CREATE POLICY "settings_auth_manage" ON app_settings
  FOR ALL TO authenticated USING (true) WITH CHECK (true);

CREATE POLICY "settings_service_role_all" ON app_settings
  FOR ALL TO service_role USING (true) WITH CHECK (true);
...
CREATE POLICY "games_auth_admin" ON games
  FOR ALL TO authenticated USING (true) WITH CHECK (true);
...
-- ── game_data ───────────────────────────────────────────────────
CREATE POLICY "game_data_own" ON game_data
  FOR ALL USING (
...
CREATE POLICY "game_data_service_role_all" ON game_data
  FOR ALL TO service_role USING (true) WITH CHECK (true);
...
CREATE POLICY "game_scores_service_role_all" ON game_scores
  FOR ALL TO service_role USING (true) WITH CHECK (true);

-- ── game_downloads ──────────────────────────────────────────────
CREATE POLICY "game_downloads_user_own" ON game_downloads
  FOR ALL USING (auth.uid() = user_id)
  WITH CHECK (auth.uid() = user_id);

CREATE POLICY "game_downloads_service_role_all" ON game_downloads
  FOR ALL TO service_role USING (true) WITH CHECK (true);

-- ── notifications_log (admin) ───────────────────────────────────
CREATE POLICY "notifications_log_auth_manage" ON notifications_log
  FOR ALL TO authenticated USING (true) WITH CHECK (true);

CREATE POLICY "notifications_log_service_role_all" ON notifications_log
  FOR ALL TO service_role USING (true) WITH CHECK (true);

-- ── notification_log (gamification) ─────────────────────────────
CREATE POLICY "notification_log_read_all" ON notification_log
  FOR SELECT TO anon, authenticated USING (true);

CREATE POLICY "notification_log_service_write" ON notification_log
  FOR ALL TO service_role USING (true) WITH CHECK (true);

-- ── videos (Edge Function) ─────────────────────────────────────
...
-- ── missing_requests ────────────────────────────────────────────
CREATE POLICY "missing_requests_public_read" ON missing_requests
  FOR SELECT TO anon, authenticated USING (true);

CREATE POLICY "missing_requests_auth_manage" ON missing_requests
  FOR ALL TO authenticated USING (true) WITH CHECK (true);

CREATE POLICY "missing_requests_service_role_all" ON missing_requests
  FOR ALL TO service_role USING (true) WITH CHECK (true);
...
CREATE POLICY "push_subs_service_role_read" ON push_subscriptions
  FOR SELECT TO service_role USING (true);
...
SELECT
  ...
  yc.channel_type,
  yc.total_imported,
  yc.is_active AS channel_active,
  yc.last_synced_at,
  cd.created_at,
  cd.updated_at
...
BEGIN
  RETURN QUERY
  SELECT gd.game_slug, gd.high_score, gd.coins, gd.plays, gd.last_played
  FROM game_data gd
  JOIN user_profiles up ON up.id = gd.user_id
  WHERE up.auth_user_id = p_auth_uid
...
BEGIN
  RETURN QUERY
  SELECT gd.high_score, gd.coins, gd.plays, gd.last_played
  FROM game_data gd
  JOIN user_profiles up ON up.id = gd.user_id
  WHERE up.auth_user_id = p_auth_uid
...
BEGIN
  ...
  DO UPDATE SET
    high_score = GREATEST(game_data.high_score, EXCLUDED.high_score),
    coins      = game_data.coins + EXCLUDED.coins,
    plays      = game_data.plays + EXCLUDED.plays,
    last_played = now();
END;
$$;
...
DECLARE
  total_coins INTEGER;
BEGIN
  SELECT COALESCE(SUM(gd.coins), 0) INTO total_coins
  FROM game_data gd
  JOIN user_profiles up ON up.id = gd.user_id
  WHERE up.auth_user_id = p_auth_uid;
...
BEGIN
  RETURN QUERY
  SELECT up.display_name, up.avatar_url, gd.high_score, gd.coins, gd.plays, gd.last_played
  FROM game_data gd
  JOIN user_profiles up ON up.id = gd.user_id
  WHERE (p_game_slug IS NULL OR gd.game_slug = p_game_slug)
  ORDER BY gd.high_score DESC
  LIMIT p_limit;
END;
$$;
...
-- ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
-- STEP 8: EDGE FUNCTION TRIGGER (videos table)
-- ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
...
AS $$
BEGIN
  -- Placeholder: can be extended to send push notifications
  -- or update materialized views when new video is inserted
  RETURN NEW;
END;
$$;
...
CREATE TRIGGER trigger_notify_new_video
  ...
  FOR EACH ROW EXECUTE FUNCTION on_new_video();


-- ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
-- STEP 9: SEED DATA (app_features + app_settings defaults)
-- ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
...
-- DONE! 🎉
-- ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
-- Total: 25 tables, 1 view, 9 RPC functions, 7 triggers,
--         40+ RLS policies, 30+ indexes, seed data
--
-- After running this:
-- 1. Go to Supabase > Authentication > Users
-- 2. Create your admin user (sign up)
-- 3. Then insert into admin_users:
--    INSERT INTO admin_users (user_id, email, role)
--    VALUES ('YOUR_USER_UUID', 'admin@playnexa.com', 'superadmin');
-- ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
